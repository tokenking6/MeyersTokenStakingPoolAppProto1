...
describe('Staking', function() {
    ...
    describe('stakeEther', function () {
        it('Transfers Funds', async function () {
            ...
            //test the change in signer1's funds balance
            expect(
            ...
            //test the change in contract funds balance
            expect(
        ...
        it('Adds a position to positions', async function () {
            ...
            expect(position.positionId).to.equal(undefined)
        ...
        describe('non-owner', function () {
            it('Reverts', async function () {
                expect(
                    ...
                    "Only Contract Owner may modify Staking Periods"
                )
    ...
    describe('closePosition', function() {
        describe('after unlock date', function () {
            it('transfers principal and interest', async () => {
                ...
                //sets new unlock date for testing purposes (backdated)
        ...
        describe('Before Unlock Date', function () {
            it('Transfers only principal', async () => {
                ...
                //this test does not set a backdated unlock date - intended to fail
