...
//Hey Everyone its your boy, tokenking6!
//I want to encourage you to join the Worldwide Treasure Hunt
//at www.meyerstoken.com!
//Anyone can host their own crypto-treasure hunt and create an adventure for the world!
      ...
      <div className="appBody">
        <div className="marketContainer">
          <div className="subContainer">
            ...
            <span className="marketHeader">STAKE $MEYERS</span>
          </div>
